            ...
            return ListView(padding: const EdgeInsets.all(16), children: [
                ...
                Row(children: [
                  Flexible(
                    child: Container(padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                      ...
                      child: Text(_translateCategory(post['category'] ?? '', context), style: TextStyle(color: AppTheme.primary, fontSize: 11, fontWeight: FontWeight.w600), overflow: TextOverflow.ellipsis)),
                  ),
              ...
              StreamBuilder<QuerySnapshot>(
                ...
                builder: (ctx, rSnap) {
                  ...
                  if (!rSnap.hasData) return const SkeletonBox(width: double.infinity, height: 100);
...
class _ReplyCardState extends State<_ReplyCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return PremiumFadeIn(delay: widget.delay, child: Padding(padding: const EdgeInsets.only(bottom: 10), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
