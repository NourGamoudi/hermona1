...
class _PredictionScreenState extends State<PredictionScreen> {
  ...
  Future<void> _predict() async {
    ...
    try {
      ...
      final docs = dailySnap.docs.where((d) {
        ...
        if (mounted) {
          ...
          showDialog(
            ...
            builder: (c) => AlertDialog(
              title: const Text('Bilan Quotidien Requis'),
              content: const Text('Veuillez remplir votre questionnaire quotidien pour obtenir une analyse précise.'),
              actions: [
      ...
      Map<String, dynamic> answers = {
        ...
        'hormonal_cycle': d['cyclePhase'] ?? 'folliculaire',
        'hygieneScore': d['lifestyleScore'] ?? 70,
      };
